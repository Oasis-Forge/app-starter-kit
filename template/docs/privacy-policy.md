...
This policy covers the {{APP_NAME}} app ("the app"). <!-- Update it in every PR that adds or changes what the app stores, shares, or requests. Remove sections that don't apply. -->
